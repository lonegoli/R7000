...
update_dns(void)
{
	...
	char iplist[1024];
	char cmd[128];
	char *domainlist[]={"connect.facebook.net","connect.facebook.com","s-static.ak.facebook.com","static.xx.fbcdn.net","static.ak.facebook.com","fbstatic-a.akamaihd.net","m.facebook.com"};
	int i,ret;
	char ipbuf[16];
